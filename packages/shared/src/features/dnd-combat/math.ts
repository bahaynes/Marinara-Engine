...
export const SPELL_CATALOG: DndSpell[] = [
  ...
  },
  {
    ...
    saveStat: "dex",
    classes: ["Wizard", "Sorcerer"],
    description: "A bright streak flashes and erupts into a fiery explosion (8d6 fire, DEX save).",
  },
  {
    id: "lightning_bolt",
    name: "Lightning Bolt",
    ...
    saveStat: "dex",
    classes: ["Wizard", "Sorcerer"],
    description: "A stroke of lightning forming a line 100 feet long blasts the target (8d6 lightning, DEX save).",
  },
  {
    id: "hunger_of_hadar",
  ...
  },
  {
    ...
    description: "Choose a point within range to unleash psychic explosion (8d6 psychic, INT save).",
  },
  {
    id: "cone_of_cold",
    name: "Cone of Cold",
    ...
    saveStat: "con",
    classes: ["Wizard", "Sorcerer"],
    description: "A blast of cold air erupts from your hands (8d8 cold, CON save).",
  },
  {
    id: "chain_lightning",
