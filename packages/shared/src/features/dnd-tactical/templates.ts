...
export abstract class AoETemplate {
  ...
  abstract getAffectedTiles(targetCoord: DndGridCoord, map: DndTacticalMap, casterCoord?: DndGridCoord): DndGridCoord[];
...
export class ConeTemplate extends AoETemplate {
  ...
  getAffectedTiles(targetCoord: DndGridCoord, map: DndTacticalMap, casterCoord?: DndGridCoord): DndGridCoord[] {
    const affected: DndGridCoord[] = [];
